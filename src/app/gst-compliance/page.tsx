        ...
        <div className="mt-8 grid grid-cols-1 gap-10 lg:grid-cols-3">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-lg text-neutral-600">
              ...
              tax credit correctly, responding to department notices on time, and avoiding avoidable
            ...
            <p className="mt-3 text-neutral-700">
              GST notices have a fixed response window — commonly 7–15 days depending on the notice
            ...
            <ul className="mt-3 space-y-2 text-neutral-700">
              ...
              <li>• 10–100% penalty for unregistered operation past the threshold</li>
            </ul>
            ...
            <p className="mt-3 text-neutral-700">
              ...
              We handle this wind-down process for clients closing or restructuring their business.
            </p>
