  ...
  },
  {
    ...
    guidance: {
      ...
      points: [
        ...
        "Check the residency rule before you commit. Singapore, Australia and New Zealand each require a locally resident director, and Sweden requires half the board to reside in the EEA. That is an ongoing obligation, not a formality at registration.",
...
export const otherServices: OtherService[] = [
  ...
  {
    slug: "company-registration-in-france",
    category: "international",
    title: "Company Registration in France",
    metaTitle: "France SAS / SARL Registration from India | Financial Sage",
    metaDescription: "Incorporate a French SAS or SARL through the guichet unique. No minimum capital, RCS registration, SIREN and VAT number, with FEMA reporting handled in India.",
    summary: "A French SAS or SARL, filed through the single formalities portal, with no minimum share capital and no nationality restriction on shareholders.",
    startingPrice: 999,
    facts: [
      { label: "Entity", value: "SAS or SARL" },
      { label: "Filed through", value: "The guichet unique (INPI formalities portal)" },
      { label: "Registered in", value: "Registre du Commerce et des Sociétés (RCS)" },
      { label: "Minimum capital", value: "None; €1 is sufficient" },
    ],
    bullets: [
      "SAS versus SARL assessment, which decides governance and social charges",
      "Statuts drafted and capital deposited with a bank or notary",
      "Filing through the guichet unique",
      "RCS registration, extrait Kbis and SIREN number",
      "VAT (TVA) registration",
    ],
  },
  {
    slug: "company-registration-in-italy",
    category: "international",
    title: "Company Registration in Italy",
    metaTitle: "Italy S.r.l. Registration from India | Financial Sage",
    metaDescription: "Form an Italian S.r.l. with notarised deed, Registro delle Imprese entry, codice fiscale and partita IVA. Simplified S.r.l.s. available at lower capital.",
    summary: "An Italian S.r.l., the standard limited company, which requires a notarised deed of incorporation and entry in the business register.",
    startingPrice: 999,
    facts: [
      { label: "Entity", value: "S.r.l., or simplified S.r.l.s." },
      { label: "Regulator", value: "Registro delle Imprese, Chamber of Commerce" },
      { label: "Minimum capital", value: "€10,000 ordinary; the S.r.l.s. route is lower" },
      { label: "Watch for", value: "The deed of incorporation must be notarised" },
    ],
    bullets: [
      "S.r.l. versus simplified S.r.l.s. assessment",
      "Codice fiscale for each shareholder and director",
      "Notarised deed of incorporation and articles",
      "Registro delle Imprese entry and REA number",
      "Partita IVA and INPS/INAIL registration where staff are hired",
    ],
  },
  {
    slug: "company-registration-in-sweden",
    category: "international",
    title: "Company Registration in Sweden",
    metaTitle: "Sweden Aktiebolag (AB) Registration from India | Financial Sage",
    metaDescription: "Register a Swedish AB with Bolagsverket. SEK 25,000 share capital, EEA board residency requirement and service agent arranged, with FEMA reporting from India.",
    summary: "A Swedish aktiebolag, which carries a share capital requirement and residency rules on the board that catch most foreign founders out.",
    startingPrice: 999,
    facts: [
      { label: "Entity", value: "Aktiebolag (AB)" },
      { label: "Regulator", value: "Bolagsverket" },
      { label: "Minimum capital", value: "SEK 25,000" },
      { label: "Local requirement", value: "Half the board must reside in the EEA" },
    ],
    bullets: [
      "Name check and Bolagsverket registration",
      "Share capital deposit and bank certificate",
      "Board composition planned around the EEA residency rule, or an exemption applied for",
      "A Swedish-resident representative to accept service, where the whole board sits abroad",
      "F-tax, VAT and employer registration with Skatteverket",
    ],
  },
  {
    slug: "company-registration-in-new-zealand",
    category: "international",
    title: "Company Registration in New Zealand",
    metaTitle: "New Zealand Company Registration from India | Financial Sage",
    metaDescription: "Register a New Zealand limited company with the Companies Office, including the resident director requirement, NZBN and IRD number.",
    summary: "A New Zealand limited company, quick to form and with no minimum capital, but requiring a resident director in place before incorporation completes.",
    startingPrice: 999,
    facts: [
      { label: "Entity", value: "Limited company" },
      { label: "Regulator", value: "New Zealand Companies Office" },
      { label: "Minimum capital", value: "None" },
      { label: "Local requirement", value: "One director resident in NZ, or in Australia and also a director of an Australian company" },
    ],
    bullets: [
      "Name reservation with the Companies Office",
      "Resident director arranged before incorporation, since it cannot complete without one",
      "Constitution where you want to depart from the default rules",
